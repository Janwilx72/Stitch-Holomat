...
# Screen settings (inherits from main application)
SCREEN_WIDTH = 1920
SCREEN_HEIGHT = 1080
...
def run(screen, camera_manager):
    """
    Runs the scrollable text display within the main application.
    Uses the provided screen to render content.
    """
...
# Debugging entry point (not used when launched from home screen)
